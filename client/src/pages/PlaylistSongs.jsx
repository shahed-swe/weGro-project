...
import { useGetTopSongsQuery, useAddMusicToPlayListMutation, useGetPlayListByIdQuery } from "../redux/services/music";
...
const PlayListSongs = () => {
    ...
    const { data: playListData } = useGetPlayListByIdQuery({ playlistId: params?.id })
        ...
        <Layout>
            <div className="flex flex-col">
                <div className="w-full flex justify-between items-center sm:flex-row flex-col mt-4 mb-10">
                    <h2 className="font-bold text-3xl text-white text-left"> {playListData?.playlist?.name} - PlayList Songs </h2>
                    <select
                ...
                <div className="flex flex-wrap sm:justify-start justify-center gap-8">
                    {playListData?.playlist?.tracks.length < 1 && <div className="text-white">No songs Available</div>}
