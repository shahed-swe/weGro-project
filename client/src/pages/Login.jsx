...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        // Call the login mutation with the provided username and password
        try {
    ...
    return (
        <div className="h-full">
            <div className="bg-yellow-400 bg-gradient-to-br from-black to-[#427d1a] h-screen overflow-hidden flex items-center justify-center">
                <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
                    ...
                    <form className="p-12 md:p-24" onSubmit={handleLogin}>
                        ...
                        {isError && <p className="text-red-500 mt-2">Login failed. Please check your credentials and try again.</p>}
                    </form>
                </div>
            </div>
        </div>
