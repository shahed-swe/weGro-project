import { HiOutlineHashtag, HiOutlineHome, HiOutlinePhotograph, HiOutlineUserGroup, HiLogin, HiUserAdd } from 'react-icons/hi';
...
export const links = [
  ...
  { name: 'Public PlayLists', to: '/play-lists', icon: HiOutlinePhotograph ,authCheck: false},
